  ...
  <div class="ubea-container">
    ...
    <div class="row">
        ...
        <div class="admin-section">
          <center><a href="enquiry"><img src ="images/enquiry.png" width="253px" height="200px"></a></center><br />
          <center><a href="enquiry" class="image-footer" ><b>Students Ꮛnquiry</b></a></center>
        </div>
      </div>
      <div class="col-md-3">
        <div class="admin-section">
          <center><a href="fee-structure" ><img src ="images/school_fees.jpg" width="253px" height="200px"></a></center><br />
          <center><a href="fee-structure" class="image-footer"><b>View Courses</b></a></center>
        </div>
      </div>
      <div class="col-md-3">
        <div class="admin-section">
          <center><a href="students-add"><img src ="images/student_add.png" width="253px" height="200px"></a></center><br />
          <center><a href="students-add" class="image-footer" ><b>Add Student</b></a></center>
        </div>
      </div>
      <div class="col-md-3">
        <div class="admin-section">
          <center><a href="students-view"><img src ="images/student_view.jpg" width="253px" height="200px"></a></center><br />
          <center><a href="students-view" class="image-footer"><b>View Students</b></a></center>
        </div>
      </div>
      <div class="col-md-3">
        <div class="admin-section">
          <center><a href="course-add"><img src ="images/student_course.jpg" width="253px" height="200px"></a></center><br />
